        ...
        <div style="display: flex;justify-content: space-between">
            ...
            <div>
                ...
                <el-button type="success" @click="exportData">
                    <i class="fa fa-level-down" aria-hidden="true" style="margin-right: 5px"></i>导出数据
                </el-button>
        ...
        <div style="margin-top: 10px">
            <el-table
                ...
                <el-table-column
                        ...
                        label="操作">
                    <template slot-scope="scope">
                        <el-button style="padding: 3px" @click="showEditEmp(scope.row)" size="mini">编辑</el-button>
                        <el-button style="padding: 3px" size="mini" type="primary">查看高级资料</el-button>
                        <el-button style="padding: 3px" @click="deleteEmp(scope.row)" size="mini" type="danger">删除
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
